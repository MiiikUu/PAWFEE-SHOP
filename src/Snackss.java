 ...
 * @author brion
 */
public class Snackss extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Snackss.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
